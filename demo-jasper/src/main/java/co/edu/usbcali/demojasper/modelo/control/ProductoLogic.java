...
public class ProductoLogic implements IProductoLogic {
    ...
    */
        ...
        try {
            ...
            if ((entity.getValorUnitario() != null) &&
                    (Utilities.checkNumberAndCheckWithPrecisionAndScale("" +
                        entity.getValorUnitario(), 16, 2) == false)) {
                throw new ZMessManager().new NotValidFormatException(
                    "valorUnitario");
            }
    ...
    public void deleteProducto(Producto entity) throws Exception {
        ...
        if (entity.getProdId() == null) {
            throw new ZMessManager().new EmptyFieldException("prodId");
        }

        List<DetalleFactura> detalleFacturas = null;

        try {
            detalleFacturas = detalleFacturaDAO.findByProperty("producto.prodId",
                    entity.getProdId());
    ...
    public void updateProducto(Producto entity) throws Exception {
        ...
        try {
            ...
            if ((entity.getValorUnitario() != null) &&
                    (Utilities.checkNumberAndCheckWithPrecisionAndScale("" +
                        entity.getValorUnitario(), 16, 0) == false)) {
                throw new ZMessManager().new NotValidFormatException(
                    "valorUnitario");
            }
    ...
    public List<ProductoDTO> getDataProducto() throws Exception {
        try {
            ...
            for (Producto productoTmp : producto) {
                ...
                productoDTO2.setProdId(productoTmp.getProdId());
                productoDTO2.setDescripcion((productoTmp.getDescripcion() != null)
                    ? productoTmp.getDescripcion() : null);
                productoDTO2.setValorUnitario((productoTmp.getValorUnitario() != null)
                    ? productoTmp.getValorUnitario() : null);
    ...
    public Producto getProducto(Integer prodId) throws Exception {
        ...
        try {
            entity = productoDAO.findById(prodId);
        } catch (Exception e) {
    ...
    * de busqueda voy a hacer.., ejemplo: where nombre=william o where nombre<>william,
	...
	public List<ProductoDTO> productosFactura(Integer factId) throws Exception {
		...
		try {
			if(factId == null) {
				throw new Exception("No ha llegado el id de la factura");
			}
			lista = productoDAO.productosFactura(factId);
		} catch (Exception e) {
			throw e;
		}
		return lista;
