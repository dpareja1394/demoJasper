    ...
    */
    ...
    public void saveCliente(Cliente entity) throws Exception {
        ...
        try {
            ...
            Object[] variables = {"identificacion", true, entity.getIdentificacion(), "="};             
            List<Cliente> clientes = findByCriteria(variables, null, null);
            if(!clientes.isEmpty()) {
            		throw new Exception("Ya existe un cliente con identificación "+entity.getIdentificacion());
            }
            ...
            if ((entity.getNombreCompleto() != null) &&
                    (Utilities.checkWordAndCheckWithlength(
                        entity.getNombreCompleto(), 255) == false)) {
                throw new ZMessManager().new NotValidFormatException(
                    "nombreCompleto");
            }
    ...
    public void deleteCliente(Cliente entity) throws Exception {
        ...
        try {
            facturas = facturaDAO.findByProperty("cliente.clieId",
                    entity.getClieId());
    ...
    public List<ClienteDTO> getDataCliente() throws Exception {
        try {
            ...
            for (Cliente clienteTmp : cliente) {
                ...
                clienteDTO2.setIdentificacion((clienteTmp.getIdentificacion() != null)
                    ? clienteTmp.getIdentificacion() : null);
                clienteDTO2.setNombreCompleto((clienteTmp.getNombreCompleto() != null)
                    ? clienteTmp.getNombreCompleto() : null);
